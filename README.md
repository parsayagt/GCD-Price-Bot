این برنامه یک ربات تلگرام است که قیمت طلا، ارزهای فیات (مانند دلار و یورو) و ارزهای دیجیتال (مانند بیت‌کوین و اتریوم) را از دو API مختلف دریافت می‌کند و به کاربران نمایش می‌دهد.
